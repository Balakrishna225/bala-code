...
//             <input className='form-control w-50 m-auto' type='text' placeholder='firstname'/>
//             <input className='form-control w-50 m-auto' type='text' placeholder='lastname'/>
//             <input className='form-control w-50 m-auto' type='text' placeholder='Email..'/>
//             <input className='form-control w-50 m-auto' type='text' placeholder='mobile'/>
